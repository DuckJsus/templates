...
//Если есть,то получает их данные и функкцией findImagesByArticle составляет список адресов на изображения при помощи артикулов, лежащие в отдельной папке
